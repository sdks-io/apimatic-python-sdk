...
from apimaticapi.http.proxy_settings import (
    ProxySettings,
)
from apimaticapi.logging.configuration.api_logging_configuration import (
...
class Configuration(HttpClientConfiguration):
    ...
    def clone_with(self, http_client_instance=None,
                   ...
                   logging_configuration=None, environment=None, custom_url=None,
                   custom_header_authentication_credentials=None, user_agent=None):
        ...
        return Configuration(
            ...
            custom_url=custom_url, user_agent=user_agent,
    ...
    def get_base_uri(self, server=Server.DEFAULT):
        ...
        """
        parameters = {
            "customUrl": {"value": self.custom_url, "encode": False},
        }
    ...
    def from_environment(cls, dotenv_path=None, **overrides):
        ...
        custom_url = os.getenv("CUSTOM_URL", "https://localhost:44301/api")
        user_agent = os.getenv("USER_AGENT", "TODO: Replace")
