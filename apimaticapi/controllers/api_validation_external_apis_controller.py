...
class ApiValidationExternalApisController(BaseController):
    ...
    def __init__(self, config):
        """Initialize ApiValidationExternalApisController object."""
        super(ApiValidationExternalApisController, self).__init__(config)

    def validate_api_via_file(self,
                              content_type,
                              file):
        """Perform a POST request to /validation/validate-via-file.
    ...
    def validate_api_via_url(self,
                             description_url):
        """Perform a GET request to /validation/validate-via-url.
