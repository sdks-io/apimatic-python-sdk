...
class BadRequestResponseSdkException(ApiException):
    def __init__(self, reason, response):
        """Initialize BadRequestResponseSdkException object.
        ...
        """
        super(BadRequestResponseSdkException, self).__init__(reason, response)
