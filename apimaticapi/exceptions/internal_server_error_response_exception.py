...
class InternalServerErrorResponseException(ApiException):
    def __init__(self, reason, response):
        """Initialize InternalServerErrorResponseException object.
        ...
        """
        super(InternalServerErrorResponseException, self).__init__(reason, response)
