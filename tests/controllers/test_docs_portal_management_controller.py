...
class DocsPortalManagementControllerTests(ControllerTestBase):
    ...
    @classmethod
    def setUpClass(cls):
        super(DocsPortalManagementControllerTests, cls).setUpClass()
        cls.controller = cls.client.docs_portal_management
    ...
    def test_publish_hosted_portal(self):
        # Parameters for the API call
        api_entity_id = '5f87f8ab9615d38a2eb990ca'

        # Perform the API call through the SDK function
        self.controller.publish_hosted_portal(api_entity_id)
    ...
    def test_publish_embedded_portal(self):
        # Parameters for the API call
        api_entity_id = '5f87f8ab9615d38a2eb990ca'

        # Perform the API call through the SDK function
        self.controller.publish_embedded_portal(api_entity_id)
    ...
    def test_generate_on_prem_portal_via_api_entity(self):
        # Parameters for the API call
        api_entity_id = '5f87f8ab9615d38a2eb990ca'

        # Perform the API call through the SDK function
        self.controller.generate_on_prem_portal_via_api_entity(api_entity_id)
    ...
    def test_unpublish_portal(self):
        # Parameters for the API call
        api_entity_id = '5f87f8ab9615d38a2eb990ca'

        # Perform the API call through the SDK function
        self.controller.unpublish_portal(api_entity_id)
